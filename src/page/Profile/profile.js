...
const profile = ({ navigation, route }) => {
  ...
  // console.log("prilfe>>>>", New.dataPat[0]);

  // const [state, setstate] = useState([]);
  // setstate(New.dataPat[0]);
  // console.log(state);
  ...
  async function GetPat() {
    ...
    setPat0(response.data.pet.rows[0]);
  }
  ...
  return (
    <View style={style.container}>
      ...
      <ScrollView>
        ...
        <Doctor
          navigation={navigation}
          header={Home ? "PET PROFILE" : "PROFILE"}
        />
        ...
        {Home ? (
          <View style={{ width: width, height: 220 }}>
            ...
            >
              <TouchableOpacity
                onPress={() => {
                  navigation.navigate("EditPetUser", { Pat0 });
                }}
                style={{
                  width: 97,
                  height: 28,
        ...
        >
            ...
            {Home ? (
              ...
              >
                <Image
                  ...
                  source={require("../../image/UserprofileB.png")}
                />
              </TouchableOpacity>
            ) : (
              <TouchableOpacity
              ...
              >
                <Image
                  style={{ width: 40, height: 40 }}
                  source={require("../../image/UserprofileC.png")}
                />
              </TouchableOpacity>
            )}
          </View>
          ...
          >
            {Home ? (
              <TouchableOpacity
                onPress={() => {}}
                style={{ width: width * 0.5, flexDirection: "row", height: 30 }}
              >
                <TouchableOpacity
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      {/* {moment(dataPat[0].age).format("YYYY")}y */}
                      {dataPat[0].age}
                    </Text>
                  </View>
                </View>
